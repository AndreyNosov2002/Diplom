...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['button-reg'])){
    ...
    if($login === '' || $email === '' || $passF === ''){
        ...
        array_push($errMsg, "Логін повинен бути більше 2-х символів");
    }elseif ($passF !== $passS) {
        array_push($errMsg, "Паролі в обох полях повинні співпадати!");
    }else{
...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['button-log'])){
    ...
    if($email === '' || $pass === '') {
        ...
        if($existence || password_verify($pass, $existence['password'])){
            ...
            array_push($errMsg, "Почта або пароль введені неправильно!");
        }
    }
}else{
    $email = '';
